...
void VulkanEngine::draw_geometry(VkCommandBuffer cmd)
{
    ...
    // camera projection
    glm::mat4 projection = glm::perspective(glm::radians(70.f), (float)_drawExtent.width / (float)_drawExtent.height, 0.1f, 10000.0f  ); //TODO: ВОЗМОЖНО ЭТО СЛОМАНО, ЗДЕСЬ БЫЛИ ПЕРВЕРНУТЫ FAR И NEAR (согласно настройкам depth testing), возможно это исправлено #define-ом
